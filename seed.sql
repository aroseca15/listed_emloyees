...
VALUES (20, "Mandy", "Yorkson", "Current", NULL, 1, NULL);

INSERT INTO staff_members(id, first_name, last_name, status, department_id, job_id, managerId )
VALUES (5, "Ray", "Benson", "Current", 4, 3, 4);

INSERT INTO staff_members(id, first_name, last_name, status, department_id, job_id, managerId )
VALUES (17, "Kelsea", "Ballerini", "Current", 4, 2, 1);

INSERT INTO staff_members(id, first_name, last_name, status, department_id, job_id, managerId )
VALUES (15,"Colbie", "Caliet", "Current", 5, 3, 2);

INSERT INTO staff_members(id, first_name, last_name, status, department_id, job_id, managerId )
VALUES (13, "Jack", "Johnson", "Current", 5,  2, 1);

INSERT INTO staff_members(id, first_name, last_name, status, department_id, job_id, managerId )
VALUES (16, "Scott", "James", "Current", 6,  2, 1);

INSERT INTO staff_members(id, first_name, last_name, status, department_id, job_id, managerId )
VALUES (14, "Tirzah", "Ericson", "Current", 1,  2, 1);

INSERT INTO staff_members(id, first_name, last_name, status, department_id, job_id, managerId )
VALUES (12, "Jackson", "Dunn", "Current", 2,  2, 1);

INSERT INTO staff_members(id, first_name, last_name, status, department_id, job_id, managerId )
VALUES (18, "Tiffany", "Sunberg", "Current", 3,  2, 1);
